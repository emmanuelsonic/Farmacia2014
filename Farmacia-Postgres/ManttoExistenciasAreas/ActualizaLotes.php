...
<tr class="MYTABLE">
<td colspan="5" align="right">&nbsp;<input type="button" id="guardar" name="guardar" value="Actualizar" onClick="javascript:ActualizaDatos(<?php echo $IdMedicina;?>,<?php echo $IdArea;?>);">
