...
function Reportes(){
	   //var query = document.getElementById('q').value;
		...
		select2		
		*/
ajax.open("GET","Reporte_Servicios.php?IdFarmacia="+IdFarmacia+"&IdSubServicio="+IdSubServicio+"&IdTerapeutico="+IdTerapeutico+"&IdMedicina="+IdMedicina+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin,true);
		ajax.send(null);
		return false;
