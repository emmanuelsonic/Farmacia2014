...
function CorregirExpediente(){
	...
	ajax.onreadystatechange=function(){
		...
		if(ajax.readyState==4){
			if(ajax.responseText=='ERROR_SESSION'){alert('Sesion caducada! \n Inicie sesion nuevamente');window.location='../signIn.php';}
			document.getElementById('CambioExpediente').innerHTML="Cambio Realizado!";
		}
	}
ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?IdNumeroExp="+IdNumeroExp+"&IdHistorialClinico="+IdHistorialClinico+"&Bandera=18",true);
		ajax.send(null);
		return false;
