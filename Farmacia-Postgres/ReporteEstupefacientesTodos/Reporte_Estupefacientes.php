...
//html { font: 100%/2.5 Arial, Helvetica, sans-serif; }
        ...
        if ($IdEmpleado != '0') {
            $t = pg_fetch_array(pg_query("select NombreEmpleado from mnt_empleados where IdEmpleado='$IdEmpleado'"));
        ...
        if ($IdSubEspecialidad != 0) {
            $t = pg_fetch_array(pg_query("select msse.IdSubServicioxEstablecimiento,NombreServicio,NombreSubServicio 
