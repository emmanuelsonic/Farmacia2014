...
function Reportes(){
	   //var query = document.getElementById('q').value;
		...
		select2		
		*/
ajax.open("GET","Reporte_Estupefacientes.php?IdSubServicio="+IdSubServicio+"&IdTerapeutico="+IdTerapeutico+"&IdMedicina="+IdMedicina+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin+"&IdEmpleado="+IdEmpleado+"&IdFarmacia="+IdFarmacia,true);
		ajax.send(null);
		return false;
