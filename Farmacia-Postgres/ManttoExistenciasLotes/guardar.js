...
ajax.open("GET","procesos/MedicamentosPorGrupo.php?IdTerapeutico="+IdTerapeutico+"&Nombre="+Nombre,true);
ajax.send(null);
return false;
...
function save(IdMedicina){
		...
		ajax.open("GET","saving.php?IdMedicina="+IdMedicina+"&Existencia="+Existencia+"&Lote="+Lotes+"&FechaVentto="+FechaVencimiento+"&PrecioLote="+PrecioUnitarioLote,true);
		ajax.send(null);
		return false;
