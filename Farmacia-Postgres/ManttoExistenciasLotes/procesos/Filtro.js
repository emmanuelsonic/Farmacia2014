...
function cargaContenido8(idSelectOrigen8)
{
	...
	if(opcionSeleccionada==0)
	{
		...
		while(listadoSelects8[x])
		{
			...
			var nuevaOpcion=document.createElement("option"); nuevaOpcion.value=0; nuevaOpcion.innerHTML="Seleccione una area";
	...
	else if(idSelectOrigen8!=listadoSelects8[listadoSelects8.length-1])
	{
		...
		var ajax=nuevoAjax();
ajax.open("GET", "procesos/proceso.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada, true);
