...
function CorregirArea(){
    ...
    ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?IdArea="+Area+"&IdFarmacia="+IdFarmacia+"&IdReceta="+IdReceta+
                    "&Fecha="+Fecha+"&IdHistorialClinico="+IdHistorialClinico+"&Bandera=14",true);
    ajax.send(null);
    return false;
...
function GuardarRecetaNueva(){
    ...
    ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?Expediente="+Expediente+"&IdMedico="+IdMedico
                    +"&Fecha="+Fecha+"&IdSubServicio="+IdSubServicio+"&IdFarmacia="+IdFarmacia+"&IdArea="+IdArea+"&IdAreaOrigen="+IdAreaOrigen
                    +"&IdPersonal="+IdPersonal+"&IdEstablecimiento="+IdEstablecimiento+"&Bandera=1",true);
    ajax.send(null);
    return false;
}//NuevaReceta
...
//******************** AREA ORIGEN **********************
function CargarAreaOrigen(IdArea){
    var ajax = xmlhttp();
    ajax.onreadystatechange=function(){
        if(ajax.readyState==1){
        /*NOTHING*/		
...
function CorregirAreaOrigen(){
    ...
    ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?IdAreaOrigen="+AreaOrigen+"&IdReceta="+IdReceta+"&Bandera=18",true);
    ajax.send(null);
    return false;
}
