...
ajax.open("GET","Reporte_Existencias.php?IdFarmacia="+IdFarmacia+"&IdArea="+IdArea+"&IdTerapeutico="+IdTerapeutico+"&IdMedicina="+IdMedicina+"&FechaInicio="+FechaInicio+"&FechaFin="+FechaFin,true);
		ajax.send(null);
		return false;
