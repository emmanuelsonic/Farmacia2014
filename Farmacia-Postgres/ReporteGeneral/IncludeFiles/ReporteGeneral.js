...
function Desplegar(IdSubEspecialidad,IdServicio,FechaInicial,FechaFinal){
    var URL="IncludeFiles/Emergente.php?IdSubEspecialidad="+IdSubEspecialidad+"&IdServicio="+IdServicio+"&FechaInicial="+FechaInicial+"&FechaFinal="+FechaFinal;
    Emergente(URL);
}
