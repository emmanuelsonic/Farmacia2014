...
submenuItem("Elminacion de Cierre",loc+"../EliminarCierre/Principal.php","","menudigitador_plain");
...
submenuItem("Configuracion de precios Anuales! ",loc+"../PreciosAnuales/Principal.php","","menudigitador_plain");
...
submenuItem("Correciones de Recetas",loc+"../Recetas_Correcciones/recetas_all.php","","menudigitador_plain");
...
submenuItem("Reporte Costo por Servicio",loc+"../Reportes/ReporteGeneral/Rep_General.php","","menudigitador_plain");
