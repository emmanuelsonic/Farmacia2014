...
function CargarCombo(IdOrigen, ValorSeleccionado) {
    ...
    if (IdOrigen == 'IdFarmacia') {
        Objeto = "ComboTerapeutico";
        Objeto2 = "ComboMedicina";
        Bandera = 1;
    }
    if (IdOrigen == 'IdTerapeutico') {
        Objeto = "ComboMedicina";
        Bandera = 2;
    }
...
function GenerarReporte() {
    ...
    /*
     ...
     select2		
     */
    ajax.open("GET", "ReporteFarmacias.php?IdFarmacia=" + IdFarmacia + "&TOP=" + TOP + "&FechaInicial=" + FechaInicial + "&FechaFinal=" + FechaFinal, true);
    ajax.send(null);
    return false;
