...
if (!isset($_SESSION["nivel"])) {
    ...
    <?php
        ...
        if ($_SESSION["TipoFarmacia"] == 1) {
            ?>
            <script language="JavaScript">
                window.location='../BusquedaRecetasMedicinaBodega/BusquedaRecetas.php';
            </script>
                <?php }
                ?>
        <html>
                    ...
                    <table width="825" border="0">
                        ...
                        <tr>
                            ...
                            <td class="FONDO"><select id="IdFarmacia" name="IdFarmacia" style="font-style:italic;" onChange="ComboArea(this.value);">
                                    ...
                                    <?php
                                    conexion::conectar();
                                    echo RecetasProceso::Combo(1,$IdEstablecimiento,$IdModalidad);
        ...
        <?php
        conexion::conectar();
        echo RecetasProceso::Combo(2,$IdEstablecimiento,$IdModalidad);
        conexion::desconectar();
        ?>
                                    </select></div></td>
                            <td class="FONDO">&nbsp;</td>
