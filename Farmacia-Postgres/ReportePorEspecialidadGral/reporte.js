...
function Reportes(){
	   //var query = document.getElementById('q').value;
		...
		var select1 = document.getElementById('IdTerapeutico').value;
		var select2 = document.getElementById('IdMedicina').value;
		...
		select2		
		*/
ajax.open("GET","Reporte_Servicios.php?IdFarmacia="+IdFarmacia+"&IdSubEspecialidad="+IdSubServicio+"&select1="+select1+"&select2="+select2+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin,true);
		ajax.send(null);
		return false;
