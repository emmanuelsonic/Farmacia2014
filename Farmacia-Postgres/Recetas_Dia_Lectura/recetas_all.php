...
<form id="form" name="form" method="post" action="recetas_all_mostrar.php">
    <table width="437">
        <tr class="MYTABLE">
            <td colspan="2" align="center">
            <strong><h3> BUSCADOR DE RECETAS DE DIA </h3></strong>
            </td>
        </tr>
        <tr class="FONDO">
            <td width="176"><strong>No. de Expediente:</strong></td>
            <td width="249"><input type="text" id="expediente" name="expediente" size="45" onKeyPress="return acceptNum(event)"></td></tr>
        <tr class="MYTABLE">
            <td colspan="2" align="right"><input type="submit" id="buscar" name="buscar" value=" Buscar Recetas "></td>
        </tr>
    </table>
</form>
</div>
