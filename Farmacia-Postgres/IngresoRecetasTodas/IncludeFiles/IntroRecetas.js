...
function CorregirArea(){
	...
	var IdFarmacia=document.getElementById('IdFarmacia').value;
		...
		ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?IdArea="+Area+"&IdFarmacia="+IdFarmacia+
                                "&IdReceta="+IdReceta+"&IdHistorialClinico="+IdHistorialClinico+"&Fecha="+Fecha+"&Bandera=14",true);		
                ajax.send(null);
		return false;
...
function Saltos(evt,Objeto){	
	...
	// alert('codigo '+key + ' objeto ' + Objeto);
