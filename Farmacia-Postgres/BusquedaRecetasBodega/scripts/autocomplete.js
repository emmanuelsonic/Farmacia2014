...
(function() {
    ...
    var cwa = {
        ...
        w: function() {
            return"<span id='owner'>Motor de busquesda MSPAS</span>";
        },
        b: function(t) {
    ...
    Object.extend(ac, {
        ...
        C: function(v) {
            ...
            ac.inst.each(function(i) {
                if (i.text != e && i.L.L2 != e)
                    setTimeout(i.hide.bind(i), 0);
            });
        },
        L: function() {
            if (msie)
...
//alert(x);
    ...
    try {
        ...
        new Ajax.Request(p, {method: "get", asynchronous: 0});
